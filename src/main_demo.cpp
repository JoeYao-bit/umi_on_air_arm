...
int main()
{
    ...
    Eigen::Vector3d q_current{0.2, 0.3, -0.2};
    ...
    {
        Eigen::Vector3d q_ref = select_nearest_solution(ik_res.candidates, q_current);
        auto fk_check = scorpion3_fk(q_ref, param);
        // q_ref可作为acados MPC的关节参考
    }
